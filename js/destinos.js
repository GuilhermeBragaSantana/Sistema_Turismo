...
function updateContent(destination){
    ...
    btn.forEach(function(button){
        button.addEventListener('click', function() {
            //I kept the namPortuguese to make it easier to read.
            btn.forEach(function(botao){
                botao.classList.remove('active')
            })
            button.classList.add('active');
            updateContent(button.dataset.destination);
        })
        ...
        document.querySelector('.backgroundFirstPhotoDestination').style.backgroundColor = data.backgrounds[0];
        ...
        document.querySelector('.backgroundsecondPhotoDestination').style.backgroundColor = data.backgrounds[1];
        ...
        document.querySelector('.backgroundthirdPhotoDestination').style.backgroundColor = data.backgrounds[2];
        ...
        document.querySelector('.backgroundfourthPhotoDestination').style.backgroundColor = data.backgrounds[3];
})
}

updateContent("itacare");